...
namespace habrahabr {
    namespace entities {
        ...
        AbstractEntity::AbstractEntity(QString value, QObject* parent) : QObject(parent), value(value), valid(true) {
        }

        QString AbstractEntity::getValue() {
            return value;
        }

        bool AbstractEntity::isValid() {
            return valid;
        }
    }
}
